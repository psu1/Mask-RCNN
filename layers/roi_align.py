...
from tools.py_utils import log2
...
def pyramid_roi_align(inputs, pool_size, image_shape):
    ...
    Inputs: list(0, 1, 2, 3, 4) 0: boxes; else: Feature maps.
    ...
    # k = k_0 + log2(sqrt(w*h) / 224), k_0: initial roi_level(default 4, if use C4 feature map), k: assigned roi_level
    ...
    for i, level in enumerate(range(2, 6)):
        ...
        # Keep track of which box has been mapped to i-th level
